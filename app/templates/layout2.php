...
<div class="layout2">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="aside_nav_element dropdown">
            <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspoup="true" aria-expanded="false">
                Bienvenido<?php echo " ".$nick?>
                
            </button>

            <div class="dropdown-menu" aria-labelledyby="dropdownMenuButton">
                <a class="dropdown-item" href="index.php?ctl=profile">Perfil</a>
